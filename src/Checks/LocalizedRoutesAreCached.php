...
class LocalizedRoutesAreCached implements Check
{
    /**
    ...
    {
        return trans('self-diagnosis::checks.localized_routes_are_cached.name');
    }
    ...
    {
        return trans('self-diagnosis::checks.localized_routes_are_cached.message');
    }
